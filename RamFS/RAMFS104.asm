...
.OO_L5		LDA #&0D			;Send a final <CR>
	...
	IF VER<104
		STA &FD72
	ELSE
		EQUB &8D,&BE,&00		; Force long STA &00BE
	ENDIF
		JSR setSCR
	...
	ELSE
		EQUB &8D,&BF,&00		; Force long STA &00BF
	ENDIF
		JSR setSCR
		LDA &FD0C
		JSR set10
...
.readNVtube
	IF VER<101
		STA &FEE5			;Or send it to the Tube
	ELSE
		JSR StoreToTube
	ENDIF
...
.wrNVtube2
	IF VER<101
		LDA &FEE5			;Or load it from the Tube
	ELSE
		JSR FetchFromTube
	ENDIF
...
IF VER=100
SAVE "RAMFS100.bin", ROMstart, ROMend
ENDIF
IF VER=101
SAVE "RAMFS101.bin", ROMstart, ROMend
ENDIF
IF VER=102
SAVE "RAMFS102.bin", ROMstart, ROMend
ENDIF
IF VER=103
SAVE "RAMFS103.bin", ROMstart, ROMend
ENDIF
IF VER=104
